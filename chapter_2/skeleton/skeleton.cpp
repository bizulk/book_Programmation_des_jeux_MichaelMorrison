...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow) {
    ...
    // Create the window
    hWindow = CreateWindow(szAppName, szAppName, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT,CW_USEDEFAULT, 
                                                    NULL,
                                                    NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hWindow, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(msg)
    {
        case WM_PAINT:
            ...
            DrawText(hDC, TEXT("This is a skeleton application !"), -1,
                        &rect,
